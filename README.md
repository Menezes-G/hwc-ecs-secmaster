# hwc-ecs-secmaster
This code is related to configuring the Terraform for ECS (virtual machine to be deployed at Huawei Cloud), EIPs and ECS Agency to be used in SecMaster as a log collector.


# Huawei Cloud ECS SecMaster - Terraform

Projeto Terraform para provisionamento de uma instancia ECS na Huawei Cloud (regiao sa-brazil-1) com configuracoes de rede, seguranca e IAM voltadas para integracao com o SecMaster (Security Master) para coleta de logs.
